...
export default function SessionCommand({ onStartTraining }) {
  return (
      ...
      <div className="grid gap-6 p-5 sm:grid-cols-[1fr_auto] sm:items-center sm:p-6">
        <div>
          ...
          <p className="mt-3 max-w-xl text-sm leading-6 text-zinc-400">
            Usa un peso que te deje dos repeticiones en reserva. La repetición
            importa menos que el control.
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2 sm:w-72">
          <div className="rounded-2xl bg-black/20 p-3 text-center">
            ...
            <p className="mt-1 text-lg font-semibold text-white">24 kg</p>
          </div>
          <div className="rounded-2xl bg-black/20 p-3 text-center">
          ...
          <div className="rounded-2xl bg-black/20 p-3 text-center">
            ...
            <p className="mt-1 text-lg font-semibold text-white">3-1-1</p>
          </div>
        </div>
      </div>
